    ...
    public TaiQuInformation(String line, String switchOfLine){
        ...
        if ("111新兴线".equals(line)){
            ...
            if ("111新兴线马科支线#01杆开关".equals(switchOfLine)){
                ...
                nums = new int[]{144 ,73 ,38 ,153 ,1 ,0 ,62 ,85 ,0 ,72 };
            }
        }
